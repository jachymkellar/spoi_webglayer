...
// coordinates Plzen: 13.35,49.75; zoom: 12
//	var lonlat = new OpenLayers.LonLat(14.7,49.75).transform(new OpenLayers.Projection("EPSG:4326"),new OpenLayers.Projection("EPSG:900913"));


	var lonlat = new OpenLayers.LonLat(10.7,49.75).transform(new OpenLayers.Projection("EPSG:4326"),new OpenLayers.Projection("EPSG:900913"));
